...
# Questions organized by topic for quick generation without API calls
REAL_QUESTIONS_DB = {
    "Mathematics": {
        "mcq": [
            {"question": "What is the value of π (pi)?", "options": ["3.12", "3.14", "3.16", "3.18"], "correct": "B", "difficulty": "easy"},
            {"question": "If x + 5 = 12, what is the value of x?", "options": ["7", "8", "17", "60"], "correct": "A", "difficulty": "easy"},
            {"question": "What is the area of a circle with radius 5?", "options": ["15.7", "25π", "78.5", "100"], "correct": "C", "difficulty": "medium"},
            {"question": "What is the derivative of x²?", "options": ["x", "2x", "x²", "2x²"], "correct": "B", "difficulty": "hard"},
            {"question": "Solve: 2x + 3 = 11", "options": ["4", "7", "14", "3"], "correct": "A", "difficulty": "easy"},
            {"question": "What is 15% of 200?", "options": ["15", "30", "45", "60"], "correct": "B", "difficulty": "easy"},
        ],
        "short": [
            {"question": "Explain how to find the area of a triangle.", "difficulty": "easy"},
            {"question": "What is the Pythagorean theorem and provide an example.", "difficulty": "medium"},
            {"question": "Derive the quadratic formula from ax² + bx + c = 0.", "difficulty": "hard"},
            {"question": "What is the difference between mean, median, and mode?", "difficulty": "medium"},
            {"question": "How do you convert a decimal to a percentage?", "difficulty": "easy"},
            {"question": "Explain the concept of prime numbers.", "difficulty": "easy"},
        ],
        "long": [
            {"question": "Discuss the importance of mathematical proofs and provide an example of a simple proof.", "difficulty": "hard"},
            {"question": "Explain how algebra is used in real-world applications.", "difficulty": "medium"},
            {"question": "Describe the history and significance of the number zero in mathematics.", "difficulty": "medium"},
        ]
    },
    "Science": {
        "mcq": [
            {"question": "What is the chemical formula for water?", "options": ["H₃O", "H₂O", "HO₂", "H₂O₂"], "correct": "B", "difficulty": "easy"},
            {"question": "Which organelle is responsible for energy production in cells?", "options": ["Nucleus", "Mitochondria", "Ribosome", "Lysosome"], "correct": "B", "difficulty": "medium"},
            {"question": "What is the speed of light?", "options": ["3 × 10⁸ m/s", "3 × 10⁷ m/s", "3 × 10⁹ m/s", "3 × 10⁶ m/s"], "correct": "A", "difficulty": "medium"},
            {"question": "What are the products of photosynthesis?", "options": ["Oxygen and water", "Glucose and oxygen", "Carbon dioxide and water", "Nitrogen and glucose"], "correct": "B", "difficulty": "medium"},
            {"question": "Which planet is closest to the sun?", "options": ["Venus", "Mercury", "Earth", "Mars"], "correct": "B", "difficulty": "easy"},
            {"question": "What is the pH of a neutral solution?", "options": ["0", "7", "14", "10"], "correct": "B", "difficulty": "medium"},
        ],
        "short": [
            {"question": "Describe the water cycle and its importance.", "difficulty": "easy"},
            {"question": "Explain the process of cellular respiration.", "difficulty": "medium"},
            {"question": "What is the difference between mitosis and meiosis?", "difficulty": "medium"},
            {"question": "How does natural selection lead to evolution?", "difficulty": "medium"},
            {"question": "Explain the greenhouse effect and climate change.", "difficulty": "hard"},
            {"question": "Describe the carbon cycle.", "difficulty": "medium"},
        ],
        "long": [
            {"question": "Explain the theory of evolution by natural selection and provide examples of evidence supporting it.", "difficulty": "hard"},
            {"question": "Discuss the role of DNA in heredity and protein synthesis.", "difficulty": "hard"},
            {"question": "Describe the structure and function of different ecosystems.", "difficulty": "medium"},
        ]
    },
    "English": {
        "mcq": [
            {"question": "What is a metaphor?", "options": ["A comparison using 'like' or 'as'", "A direct comparison between two things", "The repetition of beginning sounds", "An exaggeration"], "correct": "B", "difficulty": "medium"},
            {"question": "Who wrote 'Romeo and Juliet'?", "options": ["Jane Austen", "William Shakespeare", "Charles Dickens", "Mark Twain"], "correct": "B", "difficulty": "easy"},
            {"question": "What is the main theme of 'To Kill a Mockingbird'?", "options": ["Revenge", "Justice and moral growth", "Love and romance", "Adventure and exploration"], "correct": "B", "difficulty": "medium"},
            {"question": "What is an oxymoron?", "options": ["A type of metaphor", "A combination of contradictory words", "A personification", "An understatement"], "correct": "B", "difficulty": "hard"},
            {"question": "Which literary device repeats the beginning sound of words?", "options": ["Assonance", "Alliteration", "Consonance", "Onomatopoeia"], "correct": "B", "difficulty": "medium"},
            {"question": "What is the past tense of 'go'?", "options": ["Goed", "Went", "Going", "Goen"], "correct": "B", "difficulty": "easy"},
        ],
        "short": [
            {"question": "Explain the significance of the title 'Pride and Prejudice'.", "difficulty": "medium"},
            {"question": "What is symbolism in literature and provide an example.", "difficulty": "medium"},
            {"question": "Describe the difference between a protagonist and an antagonist.", "difficulty": "easy"},
            {"question": "What is a narrative perspective and list the three main types.", "difficulty": "medium"},
            {"question": "Explain the term 'irony' with examples.", "difficulty": "medium"},
            {"question": "How does imagery enhance a story?", "difficulty": "medium"},
        ],
        "long": [
            {"question": "Analyze the character development of a protagonist in a novel you've read.", "difficulty": "hard"},
            {"question": "Discuss the role of symbolism in 'The Great Gatsby' or another novel.", "difficulty": "hard"},
            {"question": "Explain how conflict drives the plot in a literary work of your choice.", "difficulty": "hard"},
        ]
    },
    "History": {
        "mcq": [
            {"question": "In what year did World War II end?", "options": ["1943", "1944", "1945", "1946"], "correct": "C", "difficulty": "easy"},
            {"question": "Who was the first President of the United States?", "options": ["Thomas Jefferson", "George Washington", "John Adams", "James Madison"], "correct": "B", "difficulty": "easy"},
            {"question": "What was the primary cause of the French Revolution?", "options": ["Religious conflict", "Economic crisis and social inequality", "Foreign invasion", "Political corruption"], "correct": "B", "difficulty": "medium"},
            {"question": "In which year did the Berlin Wall fall?", "options": ["1987", "1988", "1989", "1990"], "correct": "C", "difficulty": "medium"},
            {"question": "Who wrote the Declaration of Independence?", "options": ["Benjamin Franklin", "Thomas Jefferson", "John Hancock", "Samuel Adams"], "correct": "B", "difficulty": "medium"},
            {"question": "What was the name of the ship on which Charles Darwin traveled?", "options": ["HMS Victory", "HMS Beagle", "HMS Endeavor", "HMS Resolution"], "correct": "B", "difficulty": "hard"},
        ],
        "short": [
            {"question": "Explain the causes and consequences of the Industrial Revolution.", "difficulty": "medium"},
            {"question": "Describe the role of women in World War II.", "difficulty": "medium"},
            {"question": "What was the Renaissance and why was it important?", "difficulty": "medium"},
            {"question": "How did the printing press change society?", "difficulty": "easy"},
            {"question": "Explain the concept of colonialism and its impact.", "difficulty": "medium"},
            {"question": "What were the main goals of the Civil Rights Movement?", "difficulty": "medium"},
        ],
        "long": [
            {"question": "Discuss the factors that led to the fall of the Roman Empire.", "difficulty": "hard"},
            {"question": "Analyze the impact of the Industrial Revolution on society, economy, and the environment.", "difficulty": "hard"},
            {"question": "Explain how historical events are interpreted differently by various scholars.", "difficulty": "hard"},
        ]
    },
    "Programming": {
        "mcq": [
            {"question": "What does 'def' mean in Python?", "options": ["Definition", "Default", "Definitely", "Defer"], "correct": "A", "difficulty": "easy"},
            {"question": "Which data structure uses LIFO (Last In First Out)?", "options": ["Queue", "Stack", "Array", "Tree"], "correct": "B", "difficulty": "medium"},
            {"question": "What is the time complexity of binary search?", "options": ["O(n)", "O(n²)", "O(log n)", "O(1)"], "correct": "C", "difficulty": "hard"},
            {"question": "What keyword is used to handle errors in Python?", "options": ["catch", "handle", "try", "error"], "correct": "C", "difficulty": "medium"},
            {"question": "What is the output of: print(2 ** 3)?", "options": ["5", "6", "8", "9"], "correct": "C", "difficulty": "easy"},
            {"question": "Which loop runs at least once in most languages?", "options": ["for loop", "while loop", "do-while loop", "foreach loop"], "correct": "C", "difficulty": "medium"},
        ],
        "short": [
            {"question": "Explain the difference between a list and a tuple in Python.", "difficulty": "easy"},
            {"question": "What is recursion and provide a simple example.", "difficulty": "medium"},
            {"question": "Explain the concept of object-oriented programming.", "difficulty": "medium"},
            {"question": "What is the difference between == and 'is' in Python?", "difficulty": "medium"},
            {"question": "How does a hash table work?", "difficulty": "hard"},
            {"question": "Explain what REST API is and its main principles.", "difficulty": "medium"},
        ],
        "long": [
            {"question": "Write a program to find the factorial of a number using recursion and explain your approach.", "difficulty": "medium"},
            {"question": "Explain the concept of sorting algorithms and compare bubble sort, merge sort, and quicksort.", "difficulty": "hard"},
            {"question": "Design and explain the architecture of a simple web application.", "difficulty": "hard"},
        ]
    },
    "General": {
        "mcq": [
            {"question": "What is the capital of France?", "options": ["Lyon", "Paris", "Marseille", "Toulouse"], "correct": "B", "difficulty": "easy"},
            {"question": "What is the largest country in the world by area?", "options": ["USA", "Canada", "Russia", "China"], "correct": "C", "difficulty": "easy"},
            {"question": "How many continents are there?", "options": ["5", "6", "7", "8"], "correct": "C", "difficulty": "easy"},
            {"question": "What year did the Titanic sink?", "options": ["1912", "1913", "1914", "1915"], "correct": "A", "difficulty": "easy"},
            {"question": "What is the smallest country in the world?", "options": ["Monaco", "Vatican City", "Liechtenstein", "San Marino"], "correct": "B", "difficulty": "medium"},
            {"question": "What is the most spoken language in the world?", "options": ["Spanish", "English", "Mandarin Chinese", "Hindi"], "correct": "C", "difficulty": "medium"},
        ],
        "short": [
            {"question": "What are the major differences between renewable and non-renewable energy sources?", "difficulty": "medium"},
            {"question": "Explain the importance of biodiversity.", "difficulty": "medium"},
            {"question": "How does the internet work?", "difficulty": "hard"},
            {"question": "What are the United Nations' Sustainable Development Goals?", "difficulty": "medium"},
            {"question": "Explain the concept of artificial intelligence.", "difficulty": "medium"},
            {"question": "What is the impact of social media on society?", "difficulty": "medium"},
        ],
        "long": [
            {"question": "Discuss the causes and effects of climate change on global ecosystems.", "difficulty": "hard"},
            {"question": "Analyze the role of technology in modern education.", "difficulty": "hard"},
            {"question": "Explain the concept of globalization and its positive and negative impacts.", "difficulty": "hard"},
        ]
    }
}
...
async def generate_questions(
    session_code: str = Body(...),
    topic:        str = Body(...),
    num_questions: int = Body(6),
    question_types: List[str] = Body(["mcq", "short", "long"]),
    difficulty:   str = Body("medium"),
    api_key:      Optional[str] = Body(None),
):
    """
    Generate real educational questions for a topic.
    - Uses built-in database by default (no API key needed)
    - Uses OpenRouter API if api_key is provided for custom topics
    
    Question types: mcq, short, long
    Returns up to num_questions questions (default 6, max 20)
    """
    s = _S(session_code)
    ...
    if not question_types or not all(qt in valid_types for qt in question_types):
        raise HTTPException(400, f"question_types must be from: {valid_types}")
    
    questions = []
    source = "database"
    
    # Try to use built-in database first
    # Find matching topic (case-insensitive)
    db_topic = None
    for t in REAL_QUESTIONS_DB.keys():
    ...
    if db_topic:
        ...
        for qtype in question_types:
            if qtype in REAL_QUESTIONS_DB[db_topic]:
                candidates.extend([
                    (q, qtype) for q in REAL_QUESTIONS_DB[db_topic][qtype]
                    if q.get("difficulty", "medium") == difficulty
                ])
        
        # If not enough at exact difficulty, relax constraint
        ...
        for q_data, qtype in selected:
            ...
            task = new_task(normalized)
            questions.append(task)
        
        log.info("[QUESTIONS GENERATED] %d questions from database for topic '%s'",
                 len(questions), topic)
    
    elif api_key:
        # Use AI API for custom topics
        source = "api"
        prompt = f"""Generate {num_questions} real educational questions about "{topic}" at {difficulty} difficulty level.

Mix these question types (balance them): {', '.join(question_types)}

IMPORTANT: Generate AUTHENTIC, REAL questions that actual teachers use - NOT fake or generic questions.
Base questions on real curriculum, textbooks, and exam patterns.

For EACH question, provide this JSON format (one per line):
{{"question": "...", "type": "mcq|short|long", "options": ["A", "B", "C", "D"] (only for MCQ), "correct_answer": "A" (for MCQ) or "Brief answer" (for short/long)}}
        ...
        try:
            ...
            for line in response_text.split("\n"):
                ...
                if not line or line.startswith("#"):
                    continue
                try:
                    q = json_module.loads(line)
                    if q.get("question") and q.get("type") in valid_types:
                        normalized = normalize_task_input({
                            "question": q["question"],
                            "type": q["type"],
            ...
            if questions:
                log.info("[QUESTIONS GENERATED] %d questions from API for topic '%s'",
                         len(questions), topic)
        except Exception as exc:
            log.warning("[AI GENERATE] OpenRouter failed: %s", exc)
            raise HTTPException(500, f"Question generation failed: {str(exc)}")
    else:
        # Topic not in database and no API key
        raise HTTPException(400, 
            f"Topic '{topic}' not found in database. Available topics: {', '.join(REAL_QUESTIONS_DB.keys())}. "
            "Provide an api_key to generate questions for custom topics.")
