...
**Scope:** ClassMind Close Access (Geo-fenced attendance) feature  
...
**UI Safeguard:**
```javascript
// classmind_single.html, line 15804-15810
...
```javascript
// classmind_single.html, line 11873-11881 (joinSession)
if (accessMode === 'close') {
...
```javascript
// classmind_single.html, line 13559-13573 (getCurrentLocation)
...
```javascript
// classmind_single.html, line 13567-13574
...
**Code Reference (Frontend):**
```javascript
// classmind_single.html, line 13570
if (typeof accuracy !== 'number' || !Number.isFinite(accuracy) || accuracy > 50) {
...
**Code Path:**
```javascript
// classmind_single.html, line 11873-11875
if (accessMode === 'close') {
...
**Code Path:**
```javascript
// classmind_single.html, line 13561
if (!navigator.geolocation) {
  throw new Error('Geolocation is not available in this browser');
}
```
