...
async def verify_email_system() -> Tuple[bool, str]:
    ...
    return await send_mail_raw(from_email, "🔬 VYOM Diagnostic Test", test_html, test_text)
...
def generate_email_html(session_data: dict, teacher_name: str) -> str:
    ...
    <body>
        <div class="card">
            ...
            <div class="footer">
                VYOM Intelligence &bull; <a href="https://vyom.onrender.com" style="color: #10b981; text-decoration: none;">Dashboard</a>
            </div>
        </div>
    </body>
    </html>
...
async def send_session_email(to_email: str, session_data: dict, teacher_name: str = "Teacher") -> Tuple[bool, str]:
    ...
    return await send_mail_raw(to_email, f"VYOM Report: {session_id}", html, text)
