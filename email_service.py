...
async def send_otp_email(to_email: str, otp: str, user_name: str) -> Tuple[bool, str]:
    ...
    subject = f"ClassMind Verification Code: {otp}"
    ...
    <body>
        <div class="card">
            ...
            <div class="content">
                ...
                <p class="instructions">Use the following verification code to sign in to your ClassMind account. This code is valid for 5 minutes.</p>
                <div class="otp-box">{otp}</div>
                <p class="expiry-warning">⚠️ Do not share this code with anyone.</p>
            </div>
            <div class="footer">
                ClassMind Intelligence &bull; Secure Authentication System
            </div>
        </div>
    </body>
    </html>
    """
    text = f"Hello {user_name},\n\nYour ClassMind verification code is: {otp}\n\nThis code will expire in 5 minutes. Please do not share it with anyone."
    return await send_mail_raw(to_email, subject, html, text)
