...
def create_session_report_pdf(report: dict, teacher_email: str = "teacher@classmind.com") -> bytes:
    ...
    qr_img_tag = f'<img src="https://api.qrserver.com/v1/create-qr-code/?size=60x60&amp;data={target_url}" width="60" height="60" style="display: block; margin: auto; border-radius: 6px;" />'
